            ...
            <div className="max-w-container mx-auto px-4 md:px-8">
                ...
                <div className="flex flex-col lg:flex-row gap-8 lg:gap-24 mb-16">
                    ...
                    <div className="lg:w-2/3">
                        <p className="text-[34px] font-medium text-white leading-relaxed">
                            Early wireframes helped shape the core structure of the app.
                        </p>
                        <p className="text-[30px] font-normal text-white/90 leading-relaxed mt-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 justify-items-center">
                    {screens.map((screen, index) => (
                        <div key={index} className="flex flex-col items-center gap-4">
                            ...
                            {/* Labels */}
                            <span className="text-[30px] font-medium text-white text-center">
                                {screen.label}
                            </span>
                            <span className="text-[28px] font-normal text-white/80 text-center">
                                {screen.subLabel}
                            </span>
                        </div>
                    ))}
