            ...
            <div className="max-w-[1440px] mx-auto relative">
                ...
                <div className="grid grid-cols-2 gap-5 mb-20 md:grid-cols-1">
                    <div className="bg-white border border-[#E0E0E0] rounded-[16px] p-[30px] flex items-start gap-5 transition-transform duration-300 hover:-translate-y-[5px] hover:shadow-[0_10px_20px_rgba(0,0,0,0.05)] md:flex-col">
                        <div className="min-w-[50px] h-[50px] rounded-full flex items-center justify-center overflow-hidden"><img src="/figmaAssets/image copy 27.png" alt="User Testing" className="w-[50px] h-[50px] object-contain" /></div>
                    ...
                    <div className="bg-white border border-[#E0E0E0] rounded-[16px] p-[30px] flex items-start gap-5 transition-transform duration-300 hover:-translate-y-[5px] hover:shadow-[0_10px_20px_rgba(0,0,0,0.05)] md:flex-col">
                        <div className="min-w-[50px] h-[50px] rounded-full flex items-center justify-center overflow-hidden"><img src="/figmaAssets/image copy 28.png" alt="Iterate & Refine" className="w-[50px] h-[50px] object-contain" /></div>
                        <div className="flex-1">
                    ...
                    <div className="bg-white border border-[#E0E0E0] rounded-[16px] p-[30px] flex items-start gap-5 transition-transform duration-300 hover:-translate-y-[5px] hover:shadow-[0_10px_20px_rgba(0,0,0,0.05)] md:flex-col">
                        <div className="min-w-[50px] h-[50px] rounded-full flex items-center justify-center overflow-hidden"><img src="/figmaAssets/image copy 29.png" alt="Analytics Integration" className="w-[50px] h-[50px] object-contain" /></div>
                        <div className="flex-1">
                    ...
                    <div className="bg-white border border-[#E0E0E0] rounded-[16px] p-[30px] flex items-start gap-5 transition-transform duration-300 hover:-translate-y-[5px] hover:shadow-[0_10px_20px_rgba(0,0,0,0.05)] md:flex-col">
                        <div className="min-w-[50px] h-[50px] rounded-full flex items-center justify-center overflow-hidden"><img src="/figmaAssets/image copy 30.png" alt="Future Features" className="w-[50px] h-[50px] object-contain" /></div>
                        <div className="flex-1">
